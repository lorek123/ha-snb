...
Home Assistant integration for controlling Storz & Bickel vaporizers (Volcano Hybrid, Venty, and Crafty/Crafty+) via Bluetooth Low Energy (BLE).
...
### Button Entities
- **Boost Mode**: Activate boost mode (Crafty/Crafty+, Venty only)

## Usage

### Setting Temperature

You can set the target temperature through the climate entity:
